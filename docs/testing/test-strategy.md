...
| Testing toolkit — tools, RAGAS setup, metric guide | [docs/testing/rag-testing-toolkit.md](rag-testing-toolkit.md) |
| 89 functional test cases | [docs/testing/functional-test-scenarios.md](functional-test-scenarios.md) |
| How RAG works — concepts + test implications | [docs/concepts/how-rag-works.md](../concepts/how-rag-works.md) |
| RAG terminology reference | [docs/concepts/glossary.md](../concepts/glossary.md) |
